...
public class Labirinto {
    ...
    public Labirinto(int linhas, int colunas) {
        ...
        this.posicaoRato = new Posicao(0, 0);
    }

    public void gerar() {
        Random rand = new Random();

        // Cria paredes externas, mas deixa a [0,0] como porta de entrada
        ...
        // Coloca o Queijo em um lugar aleatório apenas no MIOLO do mapa
        int qX, qY;
        do {
        ...
        // Espalha paredes internas (obstáculos) apenas no miolo do mapa
